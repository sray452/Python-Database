...
#Example 1: Display the total number of customers from the Customers table
print("The total number of customers:")
# Count the number of customers by counting the customerIDs
cur.execute('Select count(CustomerID) AS TotalCustomers from Customers')
