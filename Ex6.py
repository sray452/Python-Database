...
print("Suppliers that are not Marketing Managers:")
# Get data of the CategoryName and Description columns of the Categories table
cur.execute('Select SupplierID, ContactName, ContactTitle from Suppliers Where ContactTitle IS NOT "Marketing Manager"')
